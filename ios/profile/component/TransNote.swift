...
class TransNote: NSObject, UIViewControllerTransitioningDelegate {
    func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        return PresNote(presentedViewController: presented, presenting: presenting)
    }
}

class PresNote: UIPresentationController {
