...
//  ios
//
//  Created by Jacob Justh on 7/31/19.
//  Copyright © 2019 bahlsenwitz. All rights reserved.
//

import UIKit

class Leader: UIViewController, UISearchBarDelegate, UISearchResultsUpdating, UITabBarDelegate {
    ...
    var leaderboardTableView: LeaderMenuTable?
    ...
    override func viewDidLoad() {
        ...
        leaderboardTableView = children.first as? LeaderMenuTable
