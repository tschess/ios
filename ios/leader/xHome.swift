...
class xHome: UIViewController, UISearchBarDelegate, UISearchResultsUpdating, UITabBarDelegate {
    ...
    var leaderboardTableView: xHomeMenuTable?
...
//    }
    ...
    override func viewDidLoad() {
        ...
        leaderboardTableView = children.first as? xHomeMenuTable
