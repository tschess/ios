...
class Chess: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UITabBarDelegate {
    
    @IBOutlet weak var backButton: UIButton!
    @IBOutlet weak var tschessLabel: UILabel!
