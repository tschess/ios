...
open class InAppPurchase: NSObject  {
    ...
    public init(productIds: Set<ProductIdentifier>) {
        ...
        for productIdentifier in productIds {
            purchased = UserDefaults.standard.bool(forKey: productIdentifier)
            if purchased {
...
extension InAppPurchase: SKPaymentTransactionObserver {
    ...
    //i think thus means you bought it, so remove one from the server...
